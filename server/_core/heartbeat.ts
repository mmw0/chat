...
const callForge = async <T>(
  ...
  // Scheduler actions execute with the configured project credentials.
  // The optional session parameter remains part of the public helper signature
  // for compatibility with callers but is not forwarded to the service.
  void userSession;
 ...
 * owner-only through the deployment scheduler administration interface.
 */
